...
fun List<UserAvailability>.toResponse(): UsersAvailabilitiesResponse {
    return fold(UsersAvailabilitiesResponse.newBuilder()) { b, u -> b.addUsersAvailabilities(u.toResponse()) }
        .build()
}
